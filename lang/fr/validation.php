...
/* Traductions de validation « fr » — laravel-lang/lang + attributs Transiatire. */
...
return [
    ...
    'attributes' => [
        ...
        'date' => 'date',
        'date_arrivee_prevue' => 'date d\'arrivée prévue',
        'date_arrivee_reelle' => 'date d\'arrivée réelle',
        'date_ata' => 'date ATA',
        'date_echeance' => 'date d\'échéance',
        'date_emission' => 'date d\'émission',
        'date_eta' => 'date ETA',
        'date_frais' => 'date du frais',
        'date_heure_chargement' => 'date/heure de chargement',
        'date_heure_livraison' => 'date/heure de livraison',
        ...
        'notes' => 'notes',
        'numero' => 'numéro',
        'numero_bl' => 'numéro de BL',
        'numero_bl_awb' => 'numéro BL/AWB',
        ...
        'transporteur_externe_id' => 'transporteur externe',
        'type' => 'type',
        'unite' => 'unité',
        'valeur' => 'valeur',
        'valeur_declaree' => 'valeur déclarée',
        'volume' => 'volume',
        'lignes.*.designation' => 'désignation',
        'lignes.*.categorie' => 'catégorie',
        'lignes.*.quantite' => 'quantité',
        'lignes.*.prix_unitaire' => 'prix unitaire',
        'contacts.*.nom' => 'nom',
        'contacts.*.fonction' => 'fonction',
        'contacts.*.telephone' => 'téléphone',
        'contacts.*.email' => 'adresse e-mail',
    ],
];
