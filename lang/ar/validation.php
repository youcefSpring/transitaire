...
/* Traductions de validation « ar » — laravel-lang/lang + attributs Transiatire. */
...
return [
    ...
    'attributes' => [
        ...
        'chauffeur_id' => 'السائق',
        'client_id' => 'العميل',
        'code_tarifaire' => 'الرمز التعريفي',
        'conditions_paiement' => 'شروط الدفع',
        'date' => 'التاريخ',
        'date_arrivee_prevue' => 'تاريخ الوصول المتوقع',
        'date_arrivee_reelle' => 'تاريخ الوصول الفعلي',
        'date_ata' => 'تاريخ الوصول الفعلي (ATA)',
        'date_echeance' => 'تاريخ الاستحقاق',
        'date_emission' => 'تاريخ الإصدار',
        'date_eta' => 'تاريخ الوصول المتوقع (ETA)',
        'date_frais' => 'تاريخ المصروف',
        'date_heure_chargement' => 'تاريخ ووقت التحميل',
        'date_heure_livraison' => 'تاريخ ووقت التسليم',
        ...
        'entrepot' => 'المستودع',
        'etape' => 'المرحلة',
        'fichier' => 'الملف المرفق',
        'fonction' => 'الوظيفة',
        'fournisseur_destinataire' => 'المورد/المرسل إليه',
        'fournisseur_id' => 'المورد',
        ...
        'notes' => 'ملاحظات',
        'numero' => 'الرقم',
        'numero_bl' => 'رقم بوليصة الشحن',
        'numero_bl_awb' => 'رقم بوليصة الشحن (BL/AWB)',
        ...
        'quantite' => 'الكمية',
        'raison' => 'السبب',
        'raison_sociale' => 'التسمية التجارية',
        ...
        'statut' => 'الحالة',
        'telephone' => 'الهاتف',
        'total_taxes' => 'مجموع الرسوم',
        'transporteur_externe_id' => 'الناقل الخارجي',
        'type' => 'النوع',
        'unite' => 'الوحدة',
        'valeur' => 'القيمة',
        'valeur_declaree' => 'القيمة المصرح بها',
        'volume' => 'الحجم',
        'lignes.*.designation' => 'البيان',
        'lignes.*.categorie' => 'الفئة',
        'lignes.*.quantite' => 'الكمية',
        'lignes.*.prix_unitaire' => 'سعر الوحدة',
        'contacts.*.nom' => 'الاسم',
        'contacts.*.fonction' => 'الوظيفة',
        'contacts.*.telephone' => 'الهاتف',
