<div class="form-grid">
    <div class="field"><label>{{ __('app.commun.nom') }} *</label><input name="name" value="{{ old('name', $user->name ?? '') }}" required></div>
    <div class="field"><label>{{ __('app.commun.email') }} *</label><input type="email" name="email" value="{{ old('email', $user->email ?? '') }}" required></div>
    <div class="field">
