...
@section('content')
    ...
    <div class="card">
        <h2>{{ __('app.dossiers.facturation') }} @can('documents-commerciaux.gerer')<a class="btn secondary small no-print" href="{{ route('documents-commerciaux.create') }}">{{ __('app.factures.nouveau') }}</a>@endcan</h2>
        <div class="table-wrap">
            <table>
